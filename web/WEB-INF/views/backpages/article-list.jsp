	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			...
			<dl id="menu-comments">
				...
				<dd>
					<ul>
						<li><a href="comment-list.html" title="评论管理">评论列表</a></li>
					</ul>
				</dd>
			</dl>
			...
			<article class="cl pd-20">
				<div class="mt-20">
					<table class="table table-border table-bordered table-bg table-hover table-sort">
						...
						<tbody>
							<c:forEach items="${list}" var="newsDto" varStatus="status">
								<tr class="text-c">
									<td>${status.count}</td>
									<td>${newsDto.title}</td>
									<td>${newsDto.type}</td>
									...
									<td class="f-14 td-manage">
										<a style="text-decoration:none" class="ml-5" href="${pageContext.request.contextPath}/news?method=toUpdate&id=${newsDto.id}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
										<a style="text-decoration:none" class="ml-5" href="${pageContext.request.contextPath}/news?method=delById&id=${newsDto.id}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
									</td>
								</tr>
							</c:forEach>
						</tbody>

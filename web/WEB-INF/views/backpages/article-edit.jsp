...
<head>
    ...
    <%--<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/simditor-2.3.6/styles/font-awesome.css" />--%>
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <select name="type">
                                <c:forEach items="${moduleList}" var="module">
                                    <option value="${module.id}" <c:if test="${news.type eq module.id}">selected</c:if>>${module.module}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
